            ...
            <div className="w-full max-w-[1400px] px-8 lg:px-16 flex items-center justify-between h-full">
                ...
                <div className="w-[25%] flex flex-col gap-10 text-left">
                    ...
                    >
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <span className="text-[0.75rem] tracking-[0.15em] text-[#d4af37] uppercase font-sans font-bold flex items-center gap-2">
                                Taux de satisfaction — <span className="text-2xl gsap-counter" data-target="98">0</span>%
                            </span>
                        </div>
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <span className="text-[0.75rem] tracking-[0.15em] text-[#d4af37] uppercase font-sans font-bold flex items-center gap-2">
                                Gain productivité — <span className="text-2xl gsap-counter" data-target="50">0</span>%
                            </span>
                        </div>
                ...
                >
                    <div className="relative w-full max-w-[480px] aspect-square lg:aspect-[4/5] p-3">
                        ...
                        <div 
                            ...
                            className="relative w-full h-full overflow-hidden bg-[#050505] group rounded-sm"
                            style={{
                                '--mouse-x': '50%',
                                '--mouse-y': '50%'
                        ...
                        <div className="absolute -bottom-10 left-0 right-0 text-center">
                            <p className="text-[#eaddc5]/50 italic font-serif text-xs" style={{ fontFamily: "var(--font-montserrat)" }}>
                                Scalset — L'excellence opérationnelle
                            </p>
                            <p className="text-[#d4af37]/80 text-[0.55rem] tracking-[0.3em] uppercase mt-3">
                ...
                <div className="w-[30%] flex flex-col justify-center text-left pl-8">
                    <motion.h2 
                        ...
                        transition={{ duration: 1, delay: 0.2 }}
                        viewport={{ once: true }}
                        className="text-4xl lg:text-5xl font-light text-transparent bg-clip-text bg-gradient-to-b from-[#ffffff] to-[#a3a3a3] mb-10 leading-[1.1] tracking-wide"
                        style={{ fontFamily: "var(--font-montserrat)" }}
                    >
                        Vous pouvez faire<br/>plus <em style={{ fontStyle: "italic", background: "linear-gradient(180deg, #ffffff 0%, #eaddc5 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>sans dépenser<br/>plus.</em>
                    </motion.h2>
                    ...
                    >
                        <p className="text-[#a3a3a3] font-sans text-[15px] leading-relaxed max-w-[90%]">
