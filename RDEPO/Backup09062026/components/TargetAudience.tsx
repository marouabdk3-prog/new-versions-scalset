    ...
    return (
        <section className="py-24 md:py-32 relative w-full flex items-center justify-center overflow-hidden bg-[#020202]">
            ...
            <div className="absolute inset-0 pointer-events-none z-0 opacity-40">
                <div className="absolute top-[20%] left-[20%] w-1 h-1 bg-[#d4af37] rounded-full blur-[2px]" />
                    ...
                    <div className="flex gap-6 w-max px-6 animate-marquee-ltr">
                        {scrollingTargets.map((target, i) => {
                            ...
                            return (
                                <div
                                    key={`${target.title}-${i}`}
                                    className="w-[85vw] max-w-[300px] md:w-[350px] md:max-w-none rounded-2xl p-8 flex flex-col items-center text-center gap-6 cursor-default group transition-all duration-700 bg-[rgba(10,10,10,0.6)] backdrop-blur-[20px] border border-[rgba(212,175,55,0.15)] shadow-[0_20px_40px_rgba(0,0,0,0.5),inset_0_1px_0_rgba(212,175,55,0.1)] hover:border-[rgba(212,175,55,0.4)] hover:shadow-[0_20px_40px_rgba(0,0,0,0.8),inset_0_1px_0_rgba(212,175,55,0.3)]"
                                >
                                    <div className="text-[#d4af37] group-hover:text-[#eaddc5] transition-all duration-700 relative shrink-0">
                                    ...
                                    <div>
                                        <h3 
                                            className="text-xl font-bold text-[#f4f4f4] mb-3 tracking-wide transition-colors duration-500"
                                            style={{ fontFamily: "var(--font-montserrat)" }}
                                        >
                                            {target.title}
                                        </h3>
                                        <p className="text-[rgba(255,255,255,0.6)] text-[15px] leading-relaxed font-sans group-hover:text-[rgba(255,255,255,0.8)] transition-colors duration-500">
                                            {target.description}
                                        </p>
                                    </div>
                                </div>
