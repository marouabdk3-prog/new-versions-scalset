    ...
    return (
        ...
        >
            ...
            >
                ...
                <div className="relative px-6 py-2.5 md:px-12 md:py-4 flex items-center justify-center rounded-[999px] bg-linear-to-b from-black/80 to-[#1a1a1a] backdrop-blur-md">
                    ...
                    <div
                        className="relative z-10 flex items-center gap-2 md:gap-3 font-bold text-sm sm:text-base md:text-xl lg:text-2xl tracking-wide transition-transform duration-300 group-hover:scale-[1.03]"
                        style={{
