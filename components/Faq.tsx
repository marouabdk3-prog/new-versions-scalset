        ...
        <section className="py-24 md:py-32 relative w-full overflow-hidden bg-[#020202]">
            ...
            <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20 relative z-10">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20 items-start">
                        ...
                        {faqs.map((faq, index) => {
                            ...
                            return (
                                <motion.div
                                    ...
                                    className="border-b border-white/[0.05] overflow-hidden group"
                                >
                                    <button
                                        onClick={() => setOpenIndex(index)}
                                        className="w-full text-left py-6 flex items-center justify-between focus:outline-none transition-all duration-500"
                                    >
                                        <span 
                                    ...
                                    <div
                                        className={`transition-all duration-500 ease-in-out ${isOpen ? "max-h-64 opacity-100 pb-8" : "max-h-0 opacity-0 pb-0"}`}
                                    >
                    ...
                    <div className="hidden lg:block sticky top-32 h-[550px] w-full rounded-2xl overflow-hidden border border-white/[0.05]">
                        <AnimatePresence mode="wait">
                            ...
                            >
                                ...
                                <div className="absolute inset-0 bg-gradient-to-t from-[#020202] via-[#020202]/30 to-transparent mix-blend-multiply" />
                                <div className="absolute inset-0 bg-[#d4af37]/[0.02] mix-blend-overlay" />
                            </motion.div>
                        </AnimatePresence>
                    </div>
